 ...
 */
final class Version20201019115828 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commandes ADD produit_id INT DEFAULT NULL, ADD nombres INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commandes DROP produit_id, DROP nombres');
    }
}
